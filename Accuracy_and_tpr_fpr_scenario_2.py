...
for model in models:
    ...
    for day in days:
        ...
        for k in range(len(y_true)):
            ...
            # if y_true[k] == 1 or y_true[k] == 2:

            if True:
                if y_true[k] in false_classes and y_prediction[k] in false_classes:
                    TN += 1

                elif y_true[k] in false_classes and y_prediction[k] == true_class:
                    # fp[k] = 1
                    FP += 1

                elif y_true[k] == true_class and y_prediction[k] == true_class:
                    TP += 1

                elif y_true[k] == true_class and y_prediction[k] in false_classes:
                    FN += 1
